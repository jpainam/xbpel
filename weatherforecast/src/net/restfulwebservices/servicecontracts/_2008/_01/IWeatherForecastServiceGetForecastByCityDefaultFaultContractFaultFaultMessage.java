...
public class IWeatherForecastServiceGetForecastByCityDefaultFaultContractFaultFaultMessage
    extends Exception
{
     ...
     * @param faultInfo
     */
    public IWeatherForecastServiceGetForecastByCityDefaultFaultContractFaultFaultMessage(String message, DefaultFaultContract faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public IWeatherForecastServiceGetForecastByCityDefaultFaultContractFaultFaultMessage(String message, DefaultFaultContract faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
